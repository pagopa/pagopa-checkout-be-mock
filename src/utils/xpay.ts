...
import { XPayPollingResponseEntity404 } from "../generated/pgs/XPayPollingResponseEntity404";
...
export const createNotFoundXPayPollingResponseEntity = (): XPayPollingResponseEntity404 => ({
  error: {
    code: 404,
