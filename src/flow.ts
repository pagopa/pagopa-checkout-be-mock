...
export enum FlowCase {
  ...
  NOTIFICATION_REQUESTED_WITH_NPG_AUTH_STATUS_EXECUTED_AND_END_PAYMENT_RESULT_OK,
  NOTIFICATION_REQUESTED_WITH_NPG_AUTH_STATUS_EXECUTED_AND_END_PAYMENT_RESULT_KO,
  // Status NOTIFICATION_ERROR
  NOTIFICATION_ERROR_WITH_NPG_AUTH_STATUS_EXECUTED_AND_END_PAYMENT_RESULT_OK,
  NOTIFICATION_ERROR_WITH_NPG_AUTH_STATUS_EXECUTED_AND_END_PAYMENT_RESULT_KO,
  // Status NOTIFIED_OK,
  NOTIFIED_OK_WITH_NPG_AUTH_STATUS_EXECUTED_AND_END_PAYMENT_RESULT_OK,
  // Status NOTIFIED_KO,
  NOTIFIED_KO_WITH_NPG_AUTH_STATUS_EXECUTED_AND_END_PAYMENT_RESULT_KO
}
