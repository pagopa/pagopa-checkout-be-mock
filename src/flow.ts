...
export enum FlowCase {
  ...
  CLOSED,
  /** pagopa-ecommerce: handle final outcome page for NPG unauthorized status */
  UNAUTHORIZED_WITH_NPG_AUTH_STATUS_EXECUTED,
  ...
  UNAUTHORIZED_WITH_NPG_AUTH_STATUS_DECLINED_ERROR_CODE_000,
